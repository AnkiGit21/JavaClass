package javaPackage;
	...
	public class ProfileUpload {
		...
		public void login() throws InterruptedException {
			...
			Thread.sleep(2000);
			try {
				driver.findElement(By.xpath("//div[@class='_yb_1fd5csz _yb_1rge8yj']")).click();

				// Locate the iframe by its id
				WebElement iframeElement = driver.findElement(By.xpath("//*[@class='_yb_dzlpat']")); // Change selector as
																										// needed
				System.out.println("Frame");

				// Switch to the iframe
				driver.switchTo().frame(driver.findElement(By.xpath("//*[@class='_yb_dzlpat']")));
				...
				// driver.findElement(By.xpath("//div[@class='modal-content-holder']"));
				
				WebDriverWait wait1 = new WebDriverWait(driver, 10);
				WebElement uploadButton = wait1
						.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[contains(text(),button)']")));
